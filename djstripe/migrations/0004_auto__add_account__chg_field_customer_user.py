...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djstripe_account', (
            ...
            ('publishable_key', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal(u'djstripe', ['Account'])


        # Changing field 'Customer.user'
        db.alter_column(u'djstripe_customer', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.User'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting model 'Account'
        db.delete_table(u'djstripe_account')
