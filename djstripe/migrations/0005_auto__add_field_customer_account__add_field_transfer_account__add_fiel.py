...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.account'
        db.add_column(u'djstripe_customer', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djstripe.Account'], null=True),
                      keep_default=False)

        # Adding field 'Transfer.account'
        db.add_column(u'djstripe_transfer', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djstripe.Account'], null=True),
                      keep_default=False)

        # Adding field 'Plan.account'
        db.add_column(u'djstripe_plan', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djstripe.Account'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.account'
        db.delete_column(u'djstripe_customer', 'account_id')

        # Deleting field 'Transfer.account'
        db.delete_column(u'djstripe_transfer', 'account_id')

        # Deleting field 'Plan.account'
        db.delete_column(u'djstripe_plan', 'account_id')
    ...
    models = {
        ...
        u'djstripe.account': {
            ...
            'publishable_key': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        u'djstripe.customer': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['djstripe.Account']", 'null': 'True'}),
